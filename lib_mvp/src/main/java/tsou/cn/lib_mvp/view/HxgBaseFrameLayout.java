...
public class HxgBaseFrameLayout<V extends BaseView, P extends HxgMvpPresenter<V>>
        extends FrameLayout implements HxgMvpCallBack<V, P> {
    ...
    public HxgBaseFrameLayout(Context context) {
        super(context);
    }

    public HxgBaseFrameLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public HxgBaseFrameLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @SuppressLint("NewApi")
    public HxgBaseFrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
