...
public class HxgBaseRelativeLayout<V extends BaseView, P extends HxgMvpPresenter<V>>
        extends RelativeLayout implements HxgMvpCallBack<V, P> {
    ...
    public HxgBaseRelativeLayout(Context context) {
        super(context);
    }

    public HxgBaseRelativeLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public HxgBaseRelativeLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }


    @SuppressLint("NewApi")
    public HxgBaseRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
